...
const CommentBnt = document.querySelectorAll(".Posts .fullpost .icons .fa-comment");
...
const commentBnt = document.querySelectorAll(".Posts .fullpost .icons .fa-paper-plane");
...
LikeBnt.forEach((Like, i) => {
    Like.addEventListener("click", () => {
        ...
        if (Like.style.background === "rgb(245, 71, 108) none repeat scroll 0% 0%") {
...
CommentBnt.forEach((comment, i) => {
    comment.addEventListener("click", () => {
        ...
        if (comment.style.background === "rgb(245, 71, 108) none repeat scroll 0% 0%") {
