...
const scon = document.querySelectorAll(".links .MyInfo .stuffcontent .content");
const fcon = document.querySelectorAll(".links .MyInfo .followercontent .content");

const sbtn = document.querySelectorAll(".links .MyInfo .stuffcontent button ");
const fbtn = document.querySelectorAll(".links .MyInfo .followercontent button ");


sbtn[0].addEventListener("click", () => {

  if(scon[0].style.height !=="25vh"){
    scon[0].style.height="25vh";
    }
    else {
      scon[0].style.height="0vh";
    }
});

fbtn[0].addEventListener("click", () => {
 
  if(fcon[0].style.height !=="25vh"){
  fcon[0].style.height="25vh";
  }
  else {
    fcon[0].style.height="0vh";
  }
});
