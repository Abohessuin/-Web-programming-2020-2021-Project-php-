...
<body>
    ...
    $sql = "SELECT name,about,bio,skills,photolink FROM user WHERE userid='$userId'";
            ...
            <div class="whiteSpace">
                <div class="content">
                    <div class="profileImg">
                        <img class="img2" src=<?php echo $photolink;?> />
                    </div>
                    <div class="inffo">
                        <div class="edit">
                            ...
                            <form method="POST" action="postsliked.php">
